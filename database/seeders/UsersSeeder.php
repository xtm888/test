...
class UsersSeeder extends Seeder
{
    ...
    public function generateBuyerAccount()
    {
        ...
        $buyer->referral_code = strtoupper(Str::random(10));
        $buyer->identifier = strtoupper(Str::random(24));
    ...
    private function generateDepositAddressSeed(User $user)
    {
        ...
        foreach ($seederCoinsClasses as $short => $coinClass) {
            ...
            try {
                ...
                $newDepositAddress = new \App\Models\VendorPurchase();
    ...
    public function generateAdminAccount()
    {
        ...
        $admin->referral_code = strtoupper(Str::random(10));
        $admin->identifier = strtoupper(Str::random(24));
