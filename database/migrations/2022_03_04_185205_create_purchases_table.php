...
return new class extends Migration {
    ...
    public function up()
    {
        Schema::create('purchases', function (Blueprint $table) {
            ...
            $table->text('message');
            $table->enum('state', array_keys(\App\Models\Purchase::$states))->default('purchased');
            $table->enum('type', array_keys(\App\Models\Purchase::$types))->default('normal');
            $table->string('coin_name', 5)->default('xmr');
